...
Generated: 2025-10-29 22:45:24

## ga_sbx::ga_sbx
**Config**:
```json
{
  "name": "ga_sbx_dim68_pop4_gens2_procW18_frozenPerGen_K1_evalFrozen",
  "train_scenarios": [],
  "eval_scenarios": [
    {
...
```json
{
  "name": "ga_uniform_dim68_pop4_gens2_procW18_frozenPerGen_K1_evalFrozen",
  "train_scenarios": [],
  "eval_scenarios": [
    {
      "name": "random_repeatable_frozen_g555_m0",
...
**Training per seed**:
- seed 0: best=221.42519685039372
...
```json
{
  "name": "de_dim68_pop4_gens2_procW18_frozenPerGen_K1_evalFrozen",
  "train_scenarios": [],
  "eval_scenarios": [
    {
      "name": "random_repeatable_frozen_g555_m0",
...
**Training per seed**:
- seed 0: best=222.4375

**Evaluation per seed**:
- seed 0: fitness_mean=202.500±0.000, score_mean=nan±0.000, acc_mean=0.925±0.000, hits_mean=112.000±0.000, deaths_mean=1.000±0.000

## cma::cma
**Config**:
```json
{
  "name": "cma_dim68_pop4_gens2_procW18_frozenPerGen_K1_evalFrozen",
  "train_scenarios": [],
  "eval_scenarios": [
    {
      "name": "random_repeatable_frozen_g555_m0",
...
**Training per seed**:
- seed 0: best=227.23664122137404

**Evaluation per seed**:
- seed 0: fitness_mean=195.444±0.000, score_mean=nan±0.000, acc_mean=0.944±0.000, hits_mean=103.000±0.000, deaths_mean=1.000±0.000
